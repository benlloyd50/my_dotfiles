...
_G.packer_plugins = {
  ...
  ["goyo.vim"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/goyo.vim",
  ...
  ["nvim-comment"] = {
    ...
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/nvim-comment",
  ...
  ["vim-transparent"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/vim-transparent",
