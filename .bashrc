...
#	config commit -m "<helpful message>"
# 	config push
...
__conda_setup="$('/home/ben/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
...
if [ -f /home/ben/.config/synth-shell/synth-shell-prompt.sh ] && [ -n "$( echo $- | grep i )" ]; then
